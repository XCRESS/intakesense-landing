          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto lg:mx-0">
                <button className="group flex-1 min-h-[56px] px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-2xl font-bold text-lg shadow-xl">
                  <span className="flex items-center justify-center gap-3">
                    <span>Start Hiring</span>
                    <ArrowRight className="w-5 h-5" />
                  </span>
                </button>
                <button className="min-h-[56px] px-8 py-4 border-2 border-gray-200 text-gray-700 rounded-2xl font-semibold text-lg bg-white">
                  ROI Calculator
                </button>
              </div>
